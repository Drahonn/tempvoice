const ru = {
    // Dashboard
    "dashboard_title": "Панель временных каналов",
    "dashboard_description": "Добро пожаловать в панель управления временными каналами — изменяй и настраивай свой голосовой канал.",
