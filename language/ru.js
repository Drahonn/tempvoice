const ru = {
    ...
    "claim_desc": "Забрать канал, если владелец вышел",
    ...
    // DND
    "dnd_on": "Режим 'Не беспокоить' включён. Пользователи смогут зайти, но не смогут говорить",
    ...
    // Trust
    "trust_option": "Выбери, кому разрешить подключение",
    "trust_placeholder": "Выбери пользователя",
    "trusted": "Ты дал доступ {user}. Теперь он может присоединиться",
    "log_trust": "{user} получил доступ к {channel}",

    // Untrust
    "untrust_option": "Выбери, кого удалить из списка разрешенных",
    "untrust_placeholder": "Выбери пользователя",
    "untrusted": "Ты убрал доступ у {user}. Он больше не сможет зайти",
    ...
    // Kick
    "kick_option": "Выбери, кого хочешь выгнать",
    ...
    "region_placeholder": "Выбери регион сервера",
    ...
    // Invite
    "invite_option": "Выбери, кого хочешь пригласить",
    ...
    "error_user_dms_closed": "Невозможно отправить ЛС. Возможно, ЛС пользователя закрыт или это бот",
    "log_invite": "{user} был приглашён в {channel}",

    // Privacy
    "privacy_option": "Настройка приватности — сделать канал открытым или закрытым",
    "privacy_placeholder": "Выбери вариант",
    "privacy_lock_label": "Закрыт",
    "privacy_lock_desc": "Только разрешенные могут зайти",
    "privacy_lock": "Канал закрыт. Только разрешенные пользователи могут зайти",
    ...
    "privacy_invisible_desc": "Канал виден только разрешенным",
    ...
    "privacy_closechat_desc": "Только разрешенные могут писать",
    "privacy_closechat": "Чат закрыт. Писать могут только разрешенные",
